        ...
        <div class="container">
            <ul>
                ...
                <li class="address-form-click"><a href="#">TP Hồ Chí Minh<i class="fa-solid fa-sort-down"></i></a></li>
                 <li><input type="text" placeholder="Tìm kiếm.... " class="search"><i class="fa-solid fa-magnifying-glass"></i> 
                <li><a href="indexGiohang.php"><button><i class="fa-solid fa-cart-shopping"></i>Giỏ hàng</button></a></li> 
    ...
    <div class="container">
        <div class="product-gallery-one-content">
            ...
            $query = "SELECT ID, AnhDaiDien, TenDienThoai, GiaTien, GiamGiaPhanTram, GiaGiam 
                      FROM sanpham
                      WHERE LoaiSanPham = 'Màn hình máy tính'";
