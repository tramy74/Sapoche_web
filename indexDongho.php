...
<head>
    ...
    <link rel="stylesheet" href="styleDongho.css">
</head>
...
xhttp.send("idList=" + encodeURIComponent(idList));
  ...
  searchInput.addEventListener("keyup", function(event) {
    ...
    <section class="chonhangtheogia">
        <div class="container">
            <h2 class="chonhangh2">Chọn đồng hồ thông minh theo yêu cầu:</h2>
            <div class="chonhang-2">

                <ul>
                    <li><a href="">Đồng hồ thông minh giá rẻ</a></li>
                    <li><a href="">Đồng hồ thông minh giá cao</a></li>
