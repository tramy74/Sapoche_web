...
<section class="chonhang">
    <div class="container">
        <div class="chonhang-1">
            <ul>
            <li><a href="#" onclick="getLogoValue('logo1')"><img src="image/logo1.webp"></a></li>
            <li><a href="#" onclick="getLogoValue('logo2')"><img src="image/logo2.webp"></a></li>
            <li><a href="#" onclick="getLogoValue('logo3')"><img src="image/logo3.webp"></a></li>
            <li><a href="#" onclick="getLogoValue('logo4')"><img src="image/logo4.webp"></a></li>
            <li><a href="#" onclick="getLogoValue('logo5')"><img src="image/logo5.webp"></a></li>
            <li><a href="#" onclick="getLogoValue('logo6')"><img src="image/logo6.webp"></a></li>
            </ul>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="product-gallery-one-content">
            ...
            if ($logo === 'logo1') {
                ...
                FROM sanpham
                WHERE LoaiSanPham = 'Điện thoại' AND HangSanXuat = 'iPhone'";
            } else
            if($logo === 'logo2'){
                $query = "SELECT ID, AnhDaiDien, TenDienThoai, GiaTien, GiamGiaPhanTram, GiaGiam 
                FROM sanpham
                WHERE LoaiSanPham = 'Điện thoại' AND HangSanXuat = 'Samsung'";
            }
            else
            if($logo === 'logo3'){
                $query = "SELECT ID, AnhDaiDien, TenDienThoai, GiaTien, GiamGiaPhanTram, GiaGiam 
                FROM sanpham
                WHERE LoaiSanPham = 'Điện thoại' AND HangSanXuat = 'Xiaomi'";
            }else
            if($logo === 'logo4'){
                $query = "SELECT ID, AnhDaiDien, TenDienThoai, GiaTien, GiamGiaPhanTram, GiaGiam 
                FROM sanpham
                WHERE LoaiSanPham = 'Điện thoại' AND HangSanXuat = 'Oppo'";
            }
            else
            if($logo === 'logo5'){
                $query = "SELECT ID, AnhDaiDien, TenDienThoai, GiaTien, GiamGiaPhanTram, GiaGiam 
                FROM sanpham
                WHERE LoaiSanPham = 'Điện thoại' AND HangSanXuat = 'Nokia'";
            }
            else
            if($logo === 'logo6'){
                $query = "SELECT ID, AnhDaiDien, TenDienThoai, GiaTien, GiamGiaPhanTram, GiaGiam 
                FROM sanpham
                WHERE LoaiSanPham = 'Điện thoại' AND HangSanXuat = 'Vivo'";
            }
            else {
                $query = "SELECT ID, AnhDaiDien, TenDienThoai, GiaTien, GiamGiaPhanTram, GiaGiam 
                      FROM sanpham
                      WHERE LoaiSanPham = 'Điện thoại'";
            }
            $result = mysqli_query($conn, $query); 
