...
xhttp.send("idList=" + encodeURIComponent(idList));
  ...
  searchInput.addEventListener("keyup", function(event) {
        ...
        <div class="container">
            <div class="chonhang-1">
                <ul>
                    ...
                    <li>
                        <a href=""><img src="image/logo4.webp"></a>
                    </li>
                   
                    <li>
                        <a href=""><img src="image/logo6.webp"></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="chonhangtheogia">
        <div class="container">
            <h2 class="chonhangh2">Chọn máy tính bảng theo yêu cầu:</h2>
            <div class="chonhang-2">

                <ul>
                    <li><a href="">Máy tính bảng giá rẻ</a></li>
                    <li><a href="">Máy tính bảng giá cao</a></li>
                    <li><a href="">Mỏng nhẹ</a></li>
                    <li><a href="">Chơi game mượt</a></li>
                </ul>
            </div>
        </div>
    </section>
