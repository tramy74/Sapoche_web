...
<head>
    ...
    <link rel="stylesheet" href="styleSacduphong.css">
</head>
    ...
    <section class="chonhang">
        <div class="container">
            <div class="chonhang-1">
                <ul>
                    <<li>
                        <a href="indexSacduphong.php"><img src="/imagedienthoai/earphone.png"></a><span>Sạc dự phòng</span>
                    </li>
                    <li>
                        <a href="indexTainghebluetooth.php"><img src="/imagedienthoai/charger.png"></a><span>Tai nghe Bluetooth</span>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="chonhang-2">
                <ul>
                    <li><span>Các thương hiệu:</span>
                       <li><a href=""><img src="image/logo1.webp"></a></li> 
                    </li>
                    <li>
                        <a href=""><img src="image/logo2.webp"></a>
                    </li>
                    <li>
                        <a href=""><img src="image/logo3.webp"></a>
                    </li>
                </ul>
            </div>
        </div>
