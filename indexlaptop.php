...
xhttp.send("idList=" + encodeURIComponent(idList));
  ...
  searchInput.addEventListener("keyup", function(event) {
    ...
    <section class="chonhang">
        <div class="container">
            <div class="chonhang-1">
                <ul>
                    <li>
                        <a href=""><img src="/imagedienthoai/Macbook.png"></a>
                    </li>
                    <li>
                        <a href=""><img src="/imagedienthoai/asus.png"></a>
                    </li>
                    <li>
                        <a href=""><img src="/imagedienthoai/hp.jpg"></a>
                    </li>
                    <li>
                        <a href=""><img src="/imagedienthoai/lenovo.png"></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="chonhangtheogia">
        <div class="container">
            <h2 class="chonhangh2">Chọn laptop theo yêu cầu:</h2>
            <div class="chonhang-2">

                <ul>
                    <li><a href="">Laptop giá rẻ</a></li>
                    <li><a href="">Laptop giá cao</a></li>
